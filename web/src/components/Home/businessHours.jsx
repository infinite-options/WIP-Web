...
import { editBusinessHoursStatus, editBusinessHours, submitBusinessHours, } from '../../reducers/actions/venueActions';
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'Su',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['Su'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'Su',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['Su'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'M',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['M'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'M',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['M'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'T',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['T'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'T',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['T'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'W',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['W'][0]}
                                    </TextField>
                                ...
                                <TableCell> 
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'W',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['W'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'Th',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['Th'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'Th',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['Th'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'F',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['F'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'F',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['F'][1]}
                                    </TextField>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'S',0,e.target.value)
                                        }}
                                    >
                                        {businessHours['S'][0]}
                                    </TextField>
                                ...
                                <TableCell>
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            this.props.editBusinessHours(businessHours,'S',1,e.target.value)
                                        }}
                                    >
                                        {businessHours['S'][1]}
                                    </TextField>
                    ...
                    <div className={styles.businessHoursButtonItem}>
                        <div className={styles.businessHoursButton}>
                            <Button
                                variant="contained"
                                color="primary"
                                onClick={() => this.props.submitBusinessHours(businessHours,this.props.venue_uid)}
                            >
                                Save
                            </Button>
                        </div>
...
export default connect(mapStateToProps, { editBusinessHoursStatus, editBusinessHours, submitBusinessHours, })(BusinessHours);