...
import { editMaxCapacityStatus, editMaxCapacity, submitMaxCapacity } from '../../reducers/actions/venueActions';
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12} md={6} className={styles.venueInfoEditing}>
                            <Button
                                ...
                                color="primary"
                                onClick={() => {
                                    this.props.submitMaxCapacity(this.props.venue_uid,this.props.newMaxCapacity)
                                }}
                            >
                                Save
                            </Button>
...
export default connect(mapStateToProps, { editMaxCapacityStatus, editMaxCapacity, submitMaxCapacity })(MaxCapacity);