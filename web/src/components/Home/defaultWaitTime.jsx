...
import { editDefaultWaitTimeStatus, editDefaultWaitTime, submitDefaultWaitTime } from '../../reducers/actions/venueActions';
                    ...
                    <Grid container>
                        <Grid item xs={12} className={styles.venueInfoEditing}>
                            <TextField
                                ...
                                onChange={(e) => {
                                    this.props.editDefaultWaitTime(e.target.value,this.props.newDefaultWaitTimeMinute)
                                }}
                                InputProps={{
                        ...
                        <Grid item xs={12} className={styles.venueInfoEditing}>
                            <TextField
                                ...
                                onChange={(e) => {
                                    this.props.editDefaultWaitTime(this.props.newDefaultWaitTimeHour,e.target.value)
                                }}
                                InputProps={{
                        ...
                        <Grid item xs={12} md={6} className={styles.venueInfoEditing}>
                            <Button
                                variant="contained"
                                color="primary"
                                onClick={() => this.props.submitDefaultWaitTime(this.props.venue_uid,this.props.newDefaultWaitTimeHour,this.props.newDefaultWaitTimeMinute)}
                            >
                                Save
                            </Button>
                        </Grid>
    ...
    render() {
        return (
            <div className={styles.venueInfo}>
                <Typography variant='h6' className={styles.sectionTitle}> Default Wait Time </Typography>
                <Paper className={styles.venueInfoButton}>
                    <Typography variant='body1'> {this.props.defaultWaitTime} </Typography>
...
export default connect(mapStateToProps, { editDefaultWaitTimeStatus, editDefaultWaitTime, submitDefaultWaitTime })(DefaultWaitTime);